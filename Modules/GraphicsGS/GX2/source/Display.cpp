...
static TP_GfxGS_Viewport* tvViewport;
static DisposableForegroundMemResource drcScanBuffer;
static TP_GfxGS_Viewport* drcViewport;
...
void TP_GfxGS_InitDefaultDisplays(TP_GfxGS_DisplayParamList params)
{
    ...
    TP_GfxGS_ViewportParams tvViewParams = {
        .width = 1280,
        .height = 720,
        .shaderUsable = false
    };
    tvViewport = TP_GfxGS_Viewport_Create(&tvViewParams);
    ...
    TP_GfxGS_ViewportParams drcViewParams = {
        .width = 854,
        .height = 480,
        .shaderUsable = false
    };
    drcViewport = TP_GfxGS_Viewport_Create(&drcViewParams);
...
void TP_GfxGS_Display_BeginRender(const TP_GfxGS_DisplayID id)
{
    ...
    if (id == 0)
    {
        TP_GfxGS_Viewport_BeginRender(tvViewport);
    } else
    {
        TP_GfxGS_Viewport_BeginRender(drcViewport);
    }
}
