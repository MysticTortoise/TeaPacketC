...
static TP_GfxGS_Viewport* activeViewport = nullptr;
...
void TP_GfxGS_Viewport_BeginRender(TP_GfxGS_Viewport* viewport)
{
    ...
    GX2SetViewport(0, 0, TP_GfxGS_Viewport_GetWidth(viewport), TP_GfxGS_Viewport_GetHeight(viewport), 0.0f, 1.0f);
    GX2SetScissor(0, 0, TP_GfxGS_Viewport_GetWidth(viewport), TP_GfxGS_Viewport_GetHeight(viewport));
}
...
tp_u16 TP_GfxGS_Viewport_GetWidth(TP_GfxGS_Viewport* viewport)
{
    return viewport->colorBuffer.surface.width;
}

tp_u16 TP_GfxGS_Viewport_GetHeight(TP_GfxGS_Viewport* viewport)
{
...
void TP_GfxGS_ClearColor(TP_Gfx_Color8 color)
{
    ...
    GX2ClearColor(&activeViewport->colorBuffer,
                  static_cast<float>(color.r) * CharTo1Factor,
                  static_cast<float>(color.g) * CharTo1Factor,
                  static_cast<float>(color.b) * CharTo1Factor,
                  1.0f);
