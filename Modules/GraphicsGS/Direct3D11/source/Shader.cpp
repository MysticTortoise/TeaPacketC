...
#include "TeaPacket/Graphics/GS/PlatformShader.hpp"
#include "TeaPacket/Graphics/GS/ShaderParams.h"
...
static constexpr DXGI_FORMAT GetDXGIFormatFromVertexAttribute(const TP_GfxGS_VariableType shaderVarType)
{
    ...
    case 1:
        ...
        {
        case TP_GfxGS_VariableBaseType_Float: return DXGI_FORMAT_R32_FLOAT;
        case TP_GfxGS_VariableBaseType_Int: return DXGI_FORMAT_R32_SINT;
        case TP_GfxGS_VariableBaseType_UInt: return DXGI_FORMAT_R32_UINT;
    ...
    case 2:
        switch (shaderVarType.baseType)
        {
        case TP_GfxGS_VariableBaseType_Float: return DXGI_FORMAT_R32G32_FLOAT;
        case TP_GfxGS_VariableBaseType_Int: return DXGI_FORMAT_R32G32_SINT;
        case TP_GfxGS_VariableBaseType_UInt: return DXGI_FORMAT_R32G32_UINT;
        case TP_GfxGS_VariableBaseType_None:
        default:
            return DXGI_FORMAT_UNKNOWN;
        }
    ...
    case 3:
        switch (shaderVarType.baseType)
        {
        case TP_GfxGS_VariableBaseType_Float: return DXGI_FORMAT_R32G32B32_FLOAT;
        case TP_GfxGS_VariableBaseType_Int: return DXGI_FORMAT_R32G32B32_SINT;
        case TP_GfxGS_VariableBaseType_UInt: return DXGI_FORMAT_R32G32B32_UINT;
        case TP_GfxGS_VariableBaseType_None:
        default:
            return DXGI_FORMAT_UNKNOWN;
        }
    ...
    case 4:
        switch (shaderVarType.baseType)
        {
        case TP_GfxGS_VariableBaseType_Float: return DXGI_FORMAT_R32G32B32A32_FLOAT;
        case TP_GfxGS_VariableBaseType_Int: return DXGI_FORMAT_R32G32B32A32_SINT;
        case TP_GfxGS_VariableBaseType_UInt: return DXGI_FORMAT_R32G32B32A32_UINT;
        case TP_GfxGS_VariableBaseType_None:
        default:
            return DXGI_FORMAT_UNKNOWN;
        }
...
TP_GfxGS_Shader* TP_GfxGS_Shader_Create(const TP_GfxGS_ShaderParams* params)
{
    ...
    auto* shader = new TP_GfxGS_Shader;
...
void TP_GfxGS_Shader_SetActive(TP_GfxGS_Shader* const shader)
{
...
void TP_GfxGS_Shader_Destroy(TP_GfxGS_Shader* shader)
{
    delete shader;
}
